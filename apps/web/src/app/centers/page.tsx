    ...
    return (
      <MainLayout>
        <div className="text-center py-12">
          <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-tofa-gold mx-auto"></div>
  ...
  return (
    <MainLayout>
      <PageHeader
        ...
        subtitle="Create and manage academy centers"
      />
      <div className="p-8 space-y-6">
        ...
        <div ref={formRef} className="bg-white rounded-2xl shadow-xl p-6 border-t-4 border-tofa-gold">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-2xl font-bold text-gray-900 uppercase tracking-[0.15em]">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className={`${editingCenter ? 'flex-1' : 'w-full'} bg-gradient-to-r from-yellow-500 via-amber-600 to-yellow-700 text-white font-bold py-3 px-4 rounded-lg hover:opacity-90 transition-opacity disabled:opacity-50 disabled:cursor-not-allowed shadow-md`}
                >
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6">
          <h2 className="text-2xl font-bold text-gray-900 mb-4 uppercase tracking-[0.15em]">
            📋 Existing Centers
          </h2>
