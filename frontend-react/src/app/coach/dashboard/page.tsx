          ...
          <div className="px-4 py-3 flex items-center justify-between">
            <div className="flex-1 min-w-0 flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <h1 className="text-lg font-black uppercase tracking-tight">TODAY'S SESSIONS</h1>
                <p className="text-xs font-semibold text-white/70 mt-0.5">{currentDate}</p>
              </div>
            </div>
          ...
          {sortedBatches.length === 0 ? (
            ...
            <div className="space-y-1.5">
              {sortedBatches.map((batch: Batch, index: number) => (
                <div
                  key={batch.id}
                  className="rounded-lg px-3 py-2.5 border-2 border-gray-200 bg-white hover:border-indigo-300 hover:shadow-sm transition-all duration-200"
                >
